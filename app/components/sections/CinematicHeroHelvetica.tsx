...
export default function CinematicHeroHelvetica() {
...
<div
  ref={containerRef}
  className="relative h-[280vh] bg-[#131313] text-zinc-100 font-helvetica selection:bg-white selection:text-[#131313]"
>      
      ...
      <div className="sticky top-0 h-screen w-full overflow-hidden flex items-center justify-center">
        ...
        >
          ...
          >
            ...
            <span className="text-zinc-400 text-xs uppercase tracking-[0.25em] ">
              You found us! helvetica font-family
            </span>
          </motion.div>
        ...
        >
          ...
          <div className="space-y-2">
            <span className="text-zinc-400 text-xs sm:text-sm  uppercase tracking-[0.4em] block">
              You arrived
            </span>
